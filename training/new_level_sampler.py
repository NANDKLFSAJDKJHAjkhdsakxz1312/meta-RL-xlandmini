...
class LevelSampler:
    ...
    ) -> Tuple[Sampler, Tuple[chex.Array, int]]:
        """
    ...
    def insert(
        self, sampler: Sampler, level: int, score: float, level_extra: dict = None
    ) -> Tuple[Sampler, int]:
        """
    ...
    def _insert_new(
        self, sampler: Sampler, level: int, score: float, level_extra: dict
    ) -> Tuple[Sampler, int]:
